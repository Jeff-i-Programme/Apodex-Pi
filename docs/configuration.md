...
1. **Project Anchor** is the optional regular file `<project>/RESEARCH.md`. Apodex_Pi links its relative path and injects at most the first 3600 characters. It is never generated or rewritten by compaction. A genuine user request detects an edited Anchor and intentionally replaces the previous stable Brief receipt.
