...
function stateRootForProject(projectRoot, explicitStateRoot) {
	...
	if (process.platform === "win32") {
		return resolve(process.env.LOCALAPPDATA ?? join(homedir(), "AppData", "Local"), "Apodex-Pi", "state", "capabilities");
	}
	return resolve(process.env.XDG_STATE_HOME ?? join(homedir(), ".local", "state"), "apodex-pi", "capabilities");
}
