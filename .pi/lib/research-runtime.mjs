...
export const DEFAULT_RESEARCH_RUNTIME_ROOT = join(probelabStateRoot(HARNESS_ROOT), "runtime", "projects");
...
export async function resolveResearchRuntime(cwd, options = {}) {
	...
	const runtimeRoot = resolve(options.runtimeRoot ?? process.env.PROBELAB_RUNTIME_DIR ?? DEFAULT_RESEARCH_RUNTIME_ROOT);
