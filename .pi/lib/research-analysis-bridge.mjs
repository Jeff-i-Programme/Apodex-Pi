...
export async function readCodexAnalysisContext(cwd, options = {}) {
	...
	return [
		"<probelab_codex_analysis>",
		"Independent discussion context. Discuss and inspect without taking over the Probelab Leader or treating new interpretations as evidence.",
